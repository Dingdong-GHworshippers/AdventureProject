...
public class InitData implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Booking booking1 = new Booking(null, LocalDate.now().plusDays(1), List.of(), order1, customer1, 14);
        Booking booking2 = new Booking(null, LocalDate.now().plusDays(2), List.of(), order2, customer2, 16);
        ...
        paintballMorning.getEmployees().addAll(List.of(bob));
        ...
        curlingAfternoon.getEmployees().addAll(List.of(carol));
